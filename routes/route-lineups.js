...
// ===========================
// ADD THE GET ROUTE BELOW
// ===========================

router.get("/", async (req, res) => {
  try {
    // This query selects data from the lineups table.
    // We alias the fields to match what your client expects:
...
// DELETE route to clear all lineups
